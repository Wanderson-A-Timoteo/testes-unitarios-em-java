...
public class LocacaoServiceTest {
	...
	/* Definir contador - É preciso definir como static para sair do escopo da 
	 * instancia do teste, pois sem o static a variavel é reinicializada pelo JUnit toda 
	 * vez ao executar o teste. 
	 * Ao declara como static a variavel passa a ser do escopo da classe
	 */
