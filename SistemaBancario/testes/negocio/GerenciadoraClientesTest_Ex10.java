...
public class GerenciadoraClientesTest_Ex10 {
	...
	public void setUp() {
		...
		Cliente cliente02 = new Cliente(idCLiente02, "Ryan Timóteo", 19, "ryan@gmail.com", 1, true);
	...
	public void testClienteIdadeAceitavel() throws IdadeNaoPermitidaException {
		...
		/* ========== Montagem do Cenário ========== */		
		Cliente cliente = new Cliente(1, "Wanderson", 25, "wanderson@gmail.com", 1, true);
	...
	public void testClienteIdadeAceitavel_02() throws IdadeNaoPermitidaException {
		...
		/* ========== Montagem do Cenário ========== */		
		Cliente cliente = new Cliente(1, "Wanderson", 18, "wanderson@gmail.com", 1, true);
	...
	public void testClienteIdadeAceitavel_03() throws IdadeNaoPermitidaException {
		...
		/* ========== Montagem do Cenário ========== */		
		Cliente cliente = new Cliente(1, "Wanderson", 65, "wanderson@gmail.com", 1, true);
	...
	/**
	 * Validaço da idade de um cliente quando a mesma está abaixo intervalo permitido.
	 * @author wanderson
	 * @throws IdadeNaoPermitidaException 
	 */
	...
	public void testClienteIdadeAceitavel_04() throws IdadeNaoPermitidaException {
		...
		/* ========== Montagem do Cenário ========== */		
		Cliente cliente = new Cliente(1, "Wanderson", 17, "wanderson@gmail.com", 1, true);
	...
	public void testClienteIdadeAceitavel_05() throws IdadeNaoPermitidaException {
		...
		/* ========== Montagem do Cenário ========== */		
		Cliente cliente = new Cliente(1, "Wanderson", 66, "wanderson@gmail.com", 1, true);
		/* ========== Execução ========== */
		try {
			gerClientes.validaIdade(cliente.getIdade());
			fail();
